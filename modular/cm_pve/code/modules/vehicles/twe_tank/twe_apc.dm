/obj/vehicle/multitile/twe_apc
	name = "лёгкий БТР Type 200/FCV «Senshi»"
	desc = "Type 200/FCV «Senshi» Light APC — 6-метровая, 6-метровая в ширину, 8-метровая в высоту машина поддержки RMC. Созданная на базе оригинального лёгкого кавалерийского танка FV150, его внутреннее пространство было расширено благодаря отсутствию башенной корзины и систем автозаряжания. Вход сзади."
...
/obj/vehicle/multitile/twe_apc/initialize_cameras(change_tag = FALSE)
	...
	if(change_tag)
		camera.c_tag = "#[rand(1,100)] FV150-C \"[nickname]\" БТР" //this fluff allows it to be at the start of cams list
		if(camera_int)
			camera_int.c_tag = camera.c_tag + " интерьер" //this fluff allows it to be at the start of cams list
	else
		camera.c_tag = "#[rand(1,100)] FV150-C БТР"
		if(camera_int)
...
/obj/vehicle/multitile/twe_apc/command
	name = "командный лёгкий БТР Type 200/FCV-C «Senshi»"
	desc = "Type 200/FCV «Senshi» Light APC — 6-метровая, 6-метровая в ширину, 8-метровая в высоту машина поддержки RMC. Созданная на базе оригинального лёгкого кавалерийского танка FV150, его внутреннее пространство было расширено благодаря отсутствию башенной корзины и систем автозаряжания. Вход сзади."
