...
/obj/item/weapon/gun/shotgun/pump/halo/m90
	...
	desc = "Помповый дробовик производства Weapon System Technology, состоящий на вооружении сил ККОН для ближнего боя. Питается двенадцатью 8-калиберными патронами из внутреннего трубчатого магазина с фирменной верхней зарядкой. Использует патроны MAG 15P-00B и MAG LLHB."
	icon_state = "m90"
	item_state = "m90"
	fire_sound = "gun_m90"
