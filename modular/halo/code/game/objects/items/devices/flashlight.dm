/obj/item/device/flashlight/flare/unsc
	...
	icon = 'modular/halo/icons/halo/obj/items/lighting.dmi'
	icon_state = "flare"
	item_state = "flare"
...
/obj/item/device/flashlight/flare/unsc/update_icon()
	...
	if(on)
		...
		if(show_flame)
			var/image/flame = image('modular/halo/icons/halo/obj/items/lighting.dmi', src, "flare_flame")
			flame.color = flame_tint
			flame.appearance_flags = KEEP_APART|RESET_COLOR|RESET_TRANSFORM
			var/image/flame_base = image('modular/halo/icons/halo/obj/items/lighting.dmi', src, "flare_flame")
