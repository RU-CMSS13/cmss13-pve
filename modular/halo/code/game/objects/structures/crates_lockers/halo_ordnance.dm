...
/obj/structure/closet/ordnance_canister
	...
	icon = 'modular/halo/icons/halo/obj/structures/crates_32x48.dmi'
...
/obj/structure/closet/ordnance_canister/proc/finish_open()
	open()
	var/obj/item/prop/ordnance_canister_door/door = new /obj/item/prop/ordnance_canister_door(get_turf(src))
	var/rand_x = rand(-1, 1)
...
/obj/structure/closet/ordnance_canister/dropping/weapon/srs99_sniper
	name = parent_type::name + " (SRS99-AM)"
...
/obj/structure/closet/ordnance_canister/dropping/misc/medical_resupply/Initialize()
	. = ..()
