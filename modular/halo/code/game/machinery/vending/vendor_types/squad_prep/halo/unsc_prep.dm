...
/obj/structure/machinery/cm_vending/sorted/uniform_supply/squad_prep/unsc/populate_product_list(scale)
	listed_products = list(
		...
		list("Подсумок осветительного снаряжения", floor(scale * 15), /obj/item/storage/pouch/flare/unsc, VENDOR_ITEM_REGULAR),
...
/obj/structure/machinery/cm_vending/sorted/cargo_guns/squad/unsc/populate_product_list(scale)
	listed_products = list(
		...
		list("Коробка осветительных фальшфейеров", round(scale * 1), /obj/item/ammo_box/magazine/misc/unsc/flare, VENDOR_ITEM_REGULAR),
		list("Коробка химсвета", round(scale * 1), /obj/item/ammo_box/magazine/misc/unsc/flare/chemlight, VENDOR_ITEM_REGULAR),
		list("Упаковка осветительных фальшфейеров M62", round(scale * 10), /obj/item/storage/box/flare/unsc, VENDOR_ITEM_REGULAR),
		list("Упаковка химсвета", round(scale * 10), /obj/item/storage/box/flare/chemlight, VENDOR_ITEM_REGULAR),
		list("Упаковка сигнальных фальшфейеров M73-S", round(scale * 1), /obj/item/storage/box/flare/signal/unsc, VENDOR_ITEM_REGULAR),
...
GLOBAL_LIST_INIT(cm_vending_clothing_medic_unsc, list(
		...
		list("Подсумок осветительного снаряжения", 0, /obj/item/storage/pouch/flare/unsc, MARINE_CAN_BUY_POUCH, VENDOR_ITEM_REGULAR),
