...
GLOBAL_LIST_INIT(first_names_male_chinese, list("Haoran", "Wei", "Jie", "Lei", "Tao", "Yong", "Jun", "Feng", "Ming", "Chen", "Yang", "Kai", "Jian", "Hao", "Bo", "Zhiqiang", "Weidong", "Guang", "Liang", "Chao", "Tianyu", "Zihao", "Yuxuan", "Bowen", "Yichen", "Haoyu", "Minghao", "Junhao", "Yifan", "Yuxiang", "Zehao", "Hongwei", "Junjie", "Yiming", "Yuxi", "Zixuan", "Haoxuan", "Jiahao", "Yihang", "Yuchen"))
GLOBAL_LIST_INIT(first_names_female_chinese, list("Mei", "Lan", "Juan", "Fang", "Ting", "Jing", "Li", "Xia", "Ying", "Xue", "Hui", "Yan", "Ping", "Na", "Min", "Lihua", "Xiaomei", "Shu", "Rong", "Qing", "Yuxin", "Zihan", "Yuhan", "Yinuo", "Xinyi", "Xinyan", "Yutong", "Ruoxi", "Mengyao", "Zixuan", "Jiaxin", "Yuxi", "Yuting", "Yujia", "Xinran", "Zhiruo", "Yuxiao", "Xinyue", "Wanqing", "Shihan"))
GLOBAL_LIST_INIT(last_names_chinese, list("Wang", "Li", "Zhang", "Liu", "Chen", "Yang", "Huang", "Zhao", "Wu", "Zhou", "Xu", "Sun", "Ma", "Zhu", "Hu", "Lin", "Guo", "He", "Gao", "Luo", "Liang", "Song", "Zheng", "Xie", "Han", "Tang", "Feng", "Yu", "Dong", "Xiao", "Cheng", "Cao", "Yuan", "Deng", "Fu", "Shen", "Zeng", "Peng", "Lu", "Su"))
...
GLOBAL_LIST_INIT(first_names_male_brazilian, list("José", "João", "Antônio", "Francisco", "Carlos", "Paulo", "Pedro", "Lucas", "Luíz", "Marcos", "Gabriel", "Marcelo", "Rafael", "Bruno", "Eduardo", "Ravi", "Théo", "Heitor", "Bernardo", "Joaquim", "Nicolau", "Henrique", "Felipe", "Lourenço", "Natã", "Enzo", "Otávio", "Vitor", "Valentim", "Guilherme", "Enrico", "Dante", "Raimundo", "André", "Manoel", "Alexandre", "Sebastião", "Cláudio", "Ronaldo", "Luciano", "Adriano", "Kauã", "Gael", "Enzo"))
GLOBAL_LIST_INIT(first_names_female_brazilian, list("Maria", "Ana", "Francisca", "Antônia", "Adriana", "Juliana", "Márcia", "Fernanda", "Patricia", "Aline", "Sandra", "Camila", "Amanda", "Jéssica", "Letícia", "Júlia", "Mariana", "Gabriela", "Beatriz", "Sônia", "Simone", "Rosângela", "Marlene", "Terezinha", "Angela", "Isabel", "Maitê", "Antonela", "Maia", "Yasmin", "Tainá", "Aurora","Isis"))
GLOBAL_LIST_INIT(last_names_brazilian, list("Silva", "Santos", "Oliveira", "Souza", "Sousa", "Rodrigues", "Ferreira", "Alves", "Pereira", "Lima", "Costa", "Gomes", "Ribeiro", "Martins", "Carvalho", "Almeida", "Lopes", "Soares", "Fernandes", "Vieira", "Barbosa", "Rocha", "Costa", "Dias", "Nascimento", "Andrade", "Moreira", "Nunes", "Marques", "Machado", "Mendes", "Freitas", "Cardoso", "Ramos", "Gonçalves", "Santana", "Teixeira", "Lombardi", "Ferrari", "Mancini", "Becker", "Schmidt", "Müller", "Sato", "Suzuki", "Melnyk"))

GLOBAL_LIST_INIT(first_names_male_spanish, list("Mateo","Miguel","Santiago","Juan","Sebastián","Valentino","Diego","Leonardo","Emiliano","Alejandro","David","José","Andrés","Felipe","Carlos","Nicolás","Armando","Roberto","Joaquín","Antonio","Manuel","Daniel","Miguél","Ángel","Francisco","Pablo","Pedro","Lucas","Luis","Gabriel","Rafael","Marcelo","Eduardo","Raimundo","Fábio",,"Rodrigo","Gustavo","Victorio","Geraldo","Cláudio","Sérgio","Júlio","Túlio",,"Ricardo","Jorge","Eleazar","Darío","Esteban","Fabián","Jesús","Horacio","Mauricio","Octavio","Vicente","Víctor","Javier"))
GLOBAL_LIST_INIT(first_names_female_spanish, list("Ana","Francisca","Adriana","Isabel","Luisa","Lucía","Ángela","Carmen","Camila","Catalina","Cecilia","Clara","Claudia","Cruz","Diana","Emilia","Ester","Eva","Gabriela","Inés","Isabella","Juliana","Liliana","Lorena","Leticia","Margarita","María","Martina","Matilda","Matilde","Mercedes","Milena","Natalia","Miriam","Olga","Pilar","Rosa","Samanta","Rita","Sofía","Teresa","Valentina","Verónica","Victoria","Ximena","Xochitl","Yaritza","Yolanda","Laura"))
GLOBAL_LIST_INIT(last_names_spanish, list("García","Rodríguez","González","Fernández","López","Martínez","Sánchez","Pérez","Gómez","Martín","Sosa","Flores","Díaz","Ruiz","Ramírez","Quiroga","Romero","Silva","Muñoz","Soto","Morales","Torres","Castillo","Quejano","Molina","Miranda","Campos","Ortiz","Guzmán","Vásquez","Vargas","Olivares","Ortega","Lagos","Vidal","Valdés","Mendoza","Rojas","Jiménez","Rivera","Escobar","Reyes","León","Ramos","Mejía","Chávez","Gutiérrez","Hernández"))
