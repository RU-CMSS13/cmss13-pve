	...
	switch(access_list)
		...
		if(ACCESS_LIST_TWE_ALL)
			return list(
				...
				ACCESS_TWE_MEDPREP,
				ACCESS_TWE_ENGPREP,
				ACCESS_TWE_HEVWEAPPREP,
				ACCESS_TWE_SNIPERPREP,
				ACCESS_TWE_TLPREP
			) + get_access(ACCESS_LIST_COLONIAL_ALL) + get_access(ACCESS_LIST_EMERGENCY_RESPONSE)

		if(ACCESS_LIST_TWE_TROOP)
			return list(
				ACCESS_WY_GENERAL,
				ACCESS_WY_FLIGHT,
				ACCESS_TWE_ARMORY,
...
if(ACCESS_LIST_FL_PLATOON)
			return list(
				...
				ACCESS_ILLEGAL_PIRATE_SMARTGUNNER,
				ACCESS_ILLEGAL_PIRATE_TEAMLEAD,
				ACCESS_ILLEGAL_PIRATE_SENIOR_LEAD,
