...
/obj/structure/flora/forest/small_tree
	name = "spindly tree"
	icon = 'icons/obj/structures/props/new_irvine_small_tree.dmi'
...
/obj/structure/flora/forest/bush
	name = "bushes"
	icon = 'icons/obj/structures/props/new_irvine_forest_64x64.dmi'
...
/obj/structure/flora/forest/pines
	name = "pine tree"
	icon = 'icons/obj/structures/props/new_irvine_pines.dmi'
