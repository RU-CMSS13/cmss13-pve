...
#define SHIP_MAP_NAMES list("USS Almayer", "USS Golden Arrow",  "USS Golden Arrow (Classic)", "SSV Chapaev", "SSV Laituri", "USS Rover", "USCSS Firefly", "USCSS Obsidian Falk", "USCSS Onyx Karain", "HMS Brynhild", "MI264 - Pudong Bunker", "MI410 - Bandakar Pass Staging Ground", "LV818 Firebase Zulu", "LV818 Firebase Juliet","LV818 Firebase Juliet_forecon", "LV522_Firebase_Charlie_Charlie")
