...
/datum/ammo/bullet/sniper/upp
	...
	damage = 240
	penetration = ARMOR_PENETRATION_TIER_9 //Instant deletion is fun.
	shell_casing = /obj/effect/decal/ammo_casing/cartridge
...
/datum/ammo/bullet/sniper/anti_materiel/vulture
	damage = 900 // Fully intended to vaporize anything.
...
/datum/ammo/bullet/sniper/anti_materiel/vulture/holo_target
	...
	damage = 900 // it's a big bullet but its purpose is to support marines and kill enemies by itself
