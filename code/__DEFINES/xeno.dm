...
#define XENO_ARMOR_TIER_9 60 // SS220 EDIT: PR1273 - Gibson & Kloos Lanky armor tier
...
#define XENO_HEALTH_SPIDER 200 * XENO_UNIVERSAL_HPMULT // SS220 EDIT: PR1271 - Itsy Bitsy Buggers
#define XENO_HEALTH_RUNNER 100 * XENO_UNIVERSAL_HPMULT // Killed by 1 PB
#define XENO_HEALTH_DRONE 150 * XENO_UNIVERSAL_HPMULT // SS220 EDIT: PR1277 - Movie-like Xeno Castes
#define XENO_HEALTH_SOLDIER 180 * XENO_UNIVERSAL_HPMULT // SS220 EDIT: PR1277 - Movie-like Xeno Castes
...
#define XENO_SPEED_LANKY 0.1 // SS220 EDIT: PR1273 - Gibson & Kloos Lanky speed
...
#define XENO_SPEED_RAPTOR -0.9 // SS220 EDIT: PR1277 - Movie-like Xeno Castes
#define XENO_SPEED_HELLHOUND -1
#define XENO_SPEED_SPIDER -1.1 // SS220 EDIT: PR1271 - Itsy Bitsy Buggers
#define XENO_SPEED_FASTSPIDER -1.1 // SS220 EDIT: PR1271 - Itsy Bitsy Buggers
...
#define XENO_CASTE_BODYBURSTER  "Bodyburster" // SS220 EDIT: PR1273 - Gibson & Kloos Bodyburster caste
#define XENO_CASTE_LANKY  "Lanky" // SS220 EDIT: PR1273 - Gibson & Kloos Lanky caste
// #define XENO_CASTE_LANKYBRUTE  "Lanky Brute" // SS220 EDIT: PR1273 - Gibson & Kloos Lanky Brute (commented out in upstream)
#define XENO_CASTE_SPIDER_GUARD "Spider Guard" // SS220 EDIT: PR1271 - Itsy Bitsy Buggers
#define XENO_CASTE_SPIDER_NURSE "Spider Nurse" // SS220 EDIT: PR1271 - Itsy Bitsy Buggers
#define XENO_CASTE_SPIDER_HUNTER "Spider Hunter" // SS220 EDIT: PR1271 - Itsy Bitsy Buggers
#define XENO_CASTE_GIANT_LIZARD "Giant Lizard" // SS220 EDIT: PR1271 - Itsy Bitsy Buggers
#define XENO_SPECIAL_CASTES   list(XENO_CASTE_QUEEN, XENO_CASTE_PREDALIEN, XENO_CASTE_HELLHOUND)

#define ALL_XENO_CASTES list(XENO_CASTE_LARVA, XENO_CASTE_PREDALIEN_LARVA, XENO_CASTE_FACEHUGGER, XENO_CASTE_LESSER_DRONE, XENO_CASTE_DRONE, XENO_CASTE_RUNNER, XENO_CASTE_SENTINEL, XENO_CASTE_DEFENDER, XENO_CASTE_BURROWER, XENO_CASTE_CARRIER, XENO_CASTE_HIVELORD, XENO_CASTE_LURKER, XENO_CASTE_WARRIOR, XENO_CASTE_SPITTER, XENO_CASTE_BOILER, XENO_CASTE_PRAETORIAN, XENO_CASTE_CRUSHER, XENO_CASTE_RAVAGER, XENO_CASTE_QUEEN, XENO_CASTE_PREDALIEN, XENO_CASTE_HELLHOUND, XENO_CASTE_SOLDIER, XENO_CASTE_KING, XENO_CASTE_SPIDER_GUARD, XENO_CASTE_SPIDER_NURSE, XENO_CASTE_SPIDER_HUNTER, XENO_CASTE_GIANT_LIZARD, XENO_CASTE_BODYBURSTER, XENO_CASTE_LANKY) // SS220 EDIT: PR1273 - Gibson & Kloos added Bodyburster and Lanky
