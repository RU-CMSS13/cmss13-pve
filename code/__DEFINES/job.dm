...
#define JOB_TWE_IASF_COMMANDER "IASF Commanding Officer"
#define JOB_TWE_IASF_GENERAL "IASF General"

#define JOB_TWE_IASF_SYNTH "IASF Support Synth"

#define TWE_IASF_JOB_LIST list(JOB_TWE_IASF_RIFLEMAN, JOB_TWE_IASF_ENGI, JOB_TWE_IASF_MEDIC, JOB_TWE_IASF_PILOT, JOB_TWE_IASF_SMARTGUNNER, JOB_TWE_IASF_SPECIALIST, JOB_TWE_IASF_SNIPER , JOB_TWE_IASF_TEAM_LEADER, JOB_TWE_IASF_SECTION_LEADER, JOB_TWE_IASF_TROOP_LEADER, JOB_TWE_IASF_LIEUTENANT, JOB_TWE_IASF_CAPTAIN, JOB_TWE_IASF_MAJOR, JOB_TWE_IASF_COMMANDER, JOB_TWE_IASF_GENERAL)
