...
// SS220 EDIT - START: PR #1283 Movie-ish Sections — add movie advisor/agent jobs to ROLES_MISC
GLOBAL_LIST_INIT(ROLES_MISC, list(JOB_SYNTH, JOB_WORKING_JOE, JOB_UPP_JOE, JOB_DI, JOB_CORPORATE_LIAISON, JOB_COMBAT_REPORTER, JOB_MESS_SERGEANT, JOB_WO_CORPORATE_LIAISON, JOB_WO_SYNTH, JOB_ADVISOR, JOB_UPP_ADVISOR, JOB_UPP_AGENT))
// SS220 EDIT - END
...
// SS220 EDIT - START: PR #1283 Movie-ish Sections — add movie squads to ROLES_SQUAD_ALL
GLOBAL_LIST_INIT(ROLES_SQUAD_ALL, list(SQUAD_MARINE_1, SQUAD_MARINE_2, SQUAD_MARINE_3, SQUAD_MARINE_4, SQUAD_MARINE_5, SQUAD_MARINE_CRYO, SQUAD_MARINE_INTEL, SQUAD_UPP, SQUAD_LRRP, SQUAD_PMCPLT, SQUAD_PMCPLT_SMALL, SQUAD_RMC, SQUAD_SISSI, SQUAD_ODST, SQUAD_MARINE_MOVIE, SQUAD_UPP_MOVIE)) // SS220 EDIT: keep SISSI and add HALO ODST squad + movie squads
// SS220 EDIT - END
...
GLOBAL_LIST_INIT(ROLES_AI, list(JOB_SO, JOB_SQUAD_LEADER, JOB_SQUAD_TEAM_LEADER, JOB_SQUAD_RTO, JOB_SQUAD_MEDIC, JOB_SQUAD_ENGI, JOB_SQUAD_SMARTGUN, JOB_SQUAD_MARINE)) // SS220 EDIT
...
// SS220 EDIT - START: PR #1283 Movie-ish Sections — AI role lists for movie squads
GLOBAL_LIST_INIT(ROLES_AI_MARINE_MOVIE, list(JOB_SO, JOB_SQUAD_LEADER, JOB_SQUAD_MEDIC, JOB_SQUAD_TEAM_LEADER, JOB_SQUAD_SMARTGUN, JOB_SQUAD_MARINE, JOB_ADVISOR, JOB_CORPORATE_LIAISON))
GLOBAL_LIST_INIT(ROLES_AI_UPP_MOVIE, list(JOB_UPP_AGENT, JOB_SQUAD_LEADER_UPP, JOB_SQUAD_MEDIC_UPP, JOB_SQUAD_TEAM_LEADER_UPP, JOB_SQUAD_SMARTGUN_UPP, JOB_SQUAD_MARINE_UPP, JOB_UPP_ADVISOR))
// SS220 EDIT - END
GLOBAL_LIST_INIT(ROLES_ODST, list(JOB_SQUAD_MARINE_ODST, JOB_SQUAD_SPECIALIST_ODST, JOB_SQUAD_MEDIC_ODST, JOB_SQUAD_TEAM_LEADER_ODST, JOB_SQUAD_LEADER_ODST, JOB_SQUAD_RTO_ODST)) // SS220 EDIT: HALO ODST role group
...
#define BLURB_USCM_COMBAT JOB_CO, JOB_XO, JOB_SO, JOB_WO_CO, JOB_WO_XO, JOB_WO_CHIEF_POLICE, JOB_WO_SO, JOB_WO_CREWMAN, JOB_WO_POLICE, JOB_DI,\
						JOB_SQUAD_LEADER, JOB_SQUAD_TEAM_LEADER, JOB_SQUAD_RTO, JOB_SQUAD_SPECIALIST, JOB_SQUAD_SMARTGUN, JOB_SQUAD_MEDIC, JOB_SQUAD_ENGI, JOB_SQUAD_MARINE
...
// SS220 EDIT - START: HALO faction constants for modular/halo integration
#define FACTION_UNSC "UNSC"
#define FACTION_ONI "ONI"
#define FACTION_UEG_POLICE "UEG Police"
#define FACTION_UNSCN "UNSC Navy"
#define FACTION_INSURGENT "Insurgency"
...
#define FACTION_SPECOPS_KIGYAR "Specops KigYar"
// SS220 EDIT - END

// SS220 EDIT - START: CM-PVE #1289 Observer Faction Categories — add UACG to UA list
#define FACTION_LIST_UA list(FACTION_MARINE, FACTION_ARMY, FACTION_NAVY, FACTION_UACG)
// SS220 EDIT - END
...
#define FACTION_LIST_HUMANOID list(FACTION_MARINE, FACTION_PMC, FACTION_WY, FACTION_WY_DEATHSQUAD, FACTION_CLF, FACTION_CONTRACTOR, FACTION_MARSHAL, FACTION_UPP, FACTION_FREELANCER, FACTION_SURVIVOR, FACTION_NEUTRAL, FACTION_COLONIST, FACTION_MERCENARY, FACTION_DUTCH, FACTION_HEFA, FACTION_GLADIATOR, FACTION_PIRATE, FACTION_PIZZA, FACTION_SOUTO, FACTION_YAUTJA, FACTION_ZOMBIE, FACTION_TWE, FACTION_ARMY, FACTION_NAVY, FACTION_CANC, FACTION_CANC_DOGWAR, FACTION_UA_REBEL, FACTION_TWE_REBEL, FACTION_FIL, FACTION_UNSC, FACTION_INSURGENT, FACTION_UEG_POLICE, FACTION_ONI, FACTION_UNSCN) // SS220 EDIT: include FIL/CANC Dogwar and HALO humanoid factions
...
#define FACTION_LIST_CANC list(FACTION_CANC, FACTION_CANC_DOGWAR)
...
// SS220 EDIT - START: CM-PVE #1289 Observer Faction Categories — Army/Navy/UACG faction lists
#define FACTION_LIST_ARMY list(FACTION_ARMY)
#define FACTION_LIST_NAVY list(FACTION_NAVY)
#define FACTION_LIST_UACG list(FACTION_UACG)
// SS220 EDIT - END
// SS220 EDIT - START: HALO faction grouping
#define FACTION_LIST_HALO list(FACTION_UNSC, FACTION_COVENANT, FACTION_INSURGENT, FACTION_UEG_POLICE, FACTION_ONI, FACTION_UNSCN)
#define FACTION_LIST_UNSC list(FACTION_UNSC, FACTION_UEG_POLICE, FACTION_ONI, FACTION_UNSCN)
#define FACTION_LIST_COVENANT list(FACTION_UNGGOY, FACTION_SANGHEILI, FACTION_KIGYAR, FACTION_SPECOPS_SANGHEILI, FACTION_SPECOPS_UNGGOY, FACTION_SPECOPS_KIGYAR)
// SS220 EDIT - END
