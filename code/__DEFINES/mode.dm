...
GLOBAL_LIST_INIT(ROLES_AI_FREELANCER, list(JOB_SO_FL, JOB_SQUAD_LEADER_FL, JOB_SQUAD_TEAM_LEADER_FL, JOB_SQUAD_MEDIC_FL, JOB_SQUAD_SMARTGUN_FL, JOB_SQUAD_RIFLEMAN_FL))
