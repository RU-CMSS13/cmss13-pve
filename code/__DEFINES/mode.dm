...
GLOBAL_LIST_INIT(ROLES_PMCPLT, list(JOB_PMCPLAT_OW, JOB_PMCPLAT_LEADER, JOB_PMCPLAT_FTL, JOB_PMCPLAT_SMALL_MEDIC, JOB_PMCPLAT_MEDIC, JOB_PMCPLAT_SG, JOB_PMCPLAT_STANDARD))
GLOBAL_LIST_INIT(ROLES_PMCPLT_SMALL, list(JOB_PMCPLAT_SMALL_LEADER, JOB_PMCPLAT_SMALL_FTL, JOB_PMCPLAT_SMALL_MEDIC, JOB_PMCPLAT_SMALL_ENGI, JOB_PMCPLAT_SMALL_SG, JOB_PMCPLAT_SMALL_STANDARD))
