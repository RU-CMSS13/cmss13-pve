...
GLOBAL_LIST_INIT(ROLES_AI, list(JOB_SO, JOB_DROPSHIP_PILOT, JOB_SQUAD_LEADER, JOB_SQUAD_MEDIC, JOB_SQUAD_TEAM_LEADER, JOB_SQUAD_SMARTGUN, JOB_SQUAD_MARINE,JOB_SYNTH,JOB_CORPORATE_LIAISON,JOB_CARGO_TECH))
