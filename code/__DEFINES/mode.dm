...
GLOBAL_LIST_INIT(ROLES_SQUAD_ALL, list(SQUAD_MARINE_1, SQUAD_MARINE_2, SQUAD_MARINE_3, SQUAD_MARINE_4, SQUAD_MARINE_5, SQUAD_MARINE_CRYO, SQUAD_MARINE_INTEL, SQUAD_UPP, SQUAD_LRRP, SQUAD_PMCPLT, SQUAD_PMCPLT_SMALL, SQUAD_RMC,SQUAD_MERC))
...
GLOBAL_LIST_INIT(ROLES_AI, list(JOB_SO, JOB_DROPSHIP_PILOT, JOB_SQUAD_LEADER, JOB_SQUAD_MEDIC, JOB_SQUAD_TEAM_LEADER, JOB_SQUAD_SMARTGUN, JOB_SQUAD_MARINE,JOB_SYNTH,JOB_CORPORATE_LIAISON))
...
GLOBAL_LIST_INIT(ROLES_AI_FREELANCER, list(JOB_SQUAD_RIFLEMAN_FL, JOB_SQUAD_LEADER_FL, JOB_SQUAD_MEDIC_FL, JOB_SQUAD_TEAM_LEADER_FL, JOB_SQUAD_SMARTGUN_FL, JOB_RTO_FL))
