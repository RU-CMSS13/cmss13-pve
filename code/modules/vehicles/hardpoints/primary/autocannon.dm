...
/obj/item/hardpoint/primary/autocannon/twe_tank
	name = "\improper 45-мм автоматическая пушка L26A2"
	desc = "Основное орудие Tosubishi Heavy Industrial Manufacturing для FV150. Благодаря высокой скорострельности и многоцелевым боеприпасам обеспечивает огневую мощь против пехоты, сооружений и среднебронированных целей. При умелом использовании может выводить из строя даже танки."
