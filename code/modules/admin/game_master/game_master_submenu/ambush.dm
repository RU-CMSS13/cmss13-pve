...
// SS220 EDIT - START: PR1271 - Itsy Bitsy Buggers default spawn + spider castes in ambush AI list
#define DEFAULT_SPAWN_XENO_STRING XENO_CASTE_SPIDER_GUARD
#define GAME_MASTER_AMBUSH_AI_XENOS list(XENO_CASTE_SPIDER_GUARD, XENO_CASTE_SPIDER_NURSE, XENO_CASTE_SPIDER_HUNTER, XENO_CASTE_DRONE, XENO_CASTE_WARRIOR_DRONE, XENO_CASTE_SOLDIER, XENO_CASTE_RUNNER, XENO_CASTE_LURKER, XENO_CASTE_FACEHUGGER, XENO_CASTE_SENTINEL, XENO_CASTE_SPITTER, ARACHNID_CASTE_WARRIOR, ARACHNID_CASTE_BOMBARDIER) // SS220 EDIT - Arachnid
