...
// Spawn stuff
#define DEFAULT_SPAWN_XENO_STRING XENO_CASTE_SPIDER_GUARD // SS220 EDIT: PR1271 - Itsy Bitsy Buggers default spawn changed from Drone to Spider Guard
#define GAME_MASTER_AI_XENOS list(XENO_CASTE_SPIDER_GUARD, XENO_CASTE_SPIDER_NURSE, XENO_CASTE_SPIDER_HUNTER, XENO_CASTE_GIANT_LIZARD, XENO_CASTE_DRONE, XENO_CASTE_WARRIOR_DRONE, XENO_CASTE_SOLDIER, XENO_CASTE_RUNNER, RUNNER_ACIDER, XENO_CASTE_LURKER, XENO_CASTE_CRUSHER, XENO_CASTE_DEFENDER, XENO_CASTE_SENTINEL, XENO_CASTE_SPITTER, XENO_CASTE_CARRIER, XENO_CASTE_PRAETORIAN, XENO_CASTE_RAVAGER, XENO_CASTE_PREDALIEN, XENO_CASTE_QUEEN, XENO_CASTE_KING, XENO_CASTE_FACEHUGGER, ARACHNID_CASTE_WARRIOR, ARACHNID_CASTE_BOMBARDIER) // SS220 EDIT: PR1271 - Itsy Bitsy Buggers + Arachnid
...
/datum/game_master/New(client/using_client)
	...
	game_master_phone.AddComponent(/datum/component/phone/virtual, "Game Master", "white", "Company Command", null, PHONE_DND_ON, list(FACTION_MARINE, FACTION_UPP, FACTION_COLONIST, FACTION_WY), list(FACTION_MARINE, FACTION_UPP, FACTION_COLONIST, FACTION_WY), null, using_client)
