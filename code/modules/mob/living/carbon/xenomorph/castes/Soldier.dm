// SS220 EDIT - START: PR1277 - Movie-like Xeno Castes (buffed Soldier)
/datum/caste_datum/soldier
	...
	max_health = XENO_HEALTH_SOLDIER
...
/mob/living/carbon/xenomorph/soldier
	...
	acid_blood_damage = 50 /// Strong acid blood. Should be a define in the future. // SS220 EDIT: PR1277
	acid_blood_spatter = FALSE /// Testing variable, means that their blood can melt objects in the environment. Primarily barricades. // SS220 EDIT: PR1277
