...
/obj/item/weapon/gun/launcher/rocket/anti_air
	...
	// SS220 EDIT - START: CM-PVE #1288 Anti Air GM Choice — lockon sounds + cooldown
...
/obj/item/weapon/gun/launcher/rocket/anti_air/Initialize(mapload, ...)
	. = ..()
	// SS220 EDIT - START: CM-PVE #1288 Anti Air GM Choice — init lockon sounds
	locking = new(src)
	lockon = new(src)
	// SS220 EDIT - END
	smoke = new()
...
// SS220 EDIT - START: CM-PVE #1288 Anti Air GM Choice — cleanup lockon sounds
...
// SS220 EDIT - START: CM-PVE #1288 Anti Air GM Choice — missile_launch with hit_announce
...
/obj/item/weapon/gun/launcher/rocket/anti_air/proc/hit_announce(turf/sound_turf, hit_type, missile_name)
	switch(hit_type)
		if("crash")
			playsound(sound_turf, 'modular/halo/sound/weapons/spnkr_locking/spnkr_aa_crash.ogg', 100, FALSE, 40, 5, falloff = 5)
		...
		if("damage")
			playsound(sound_turf, 'modular/halo/sound/weapons/spnkr_locking/spnkr_aa_damage.ogg', 100, FALSE, 40, 5, falloff = 5)
		...
		if("miss")
			playsound(sound_turf, 'modular/halo/sound/weapons/spnkr_locking/spnkr_aa_fail.ogg', 100, FALSE, 40, 5, falloff = 5)
